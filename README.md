...
- The use of the bootstrap widget carousel for the homepage that the user can interact with (with it auto scrolling through on a timer) as a preview of the page as not to
  ...
  <img width="428" alt="image" src="https://github.com/Neville4010/website-yipee/assets/122937544/826dce5f-ea6a-4185-b49a-ef306228edb2">
...
- The font sizing and colouring were to tie in with the overall website colour palette. This was done by adding a darker colour behind the text and using the background web page colour
  ...
  <img width="753" alt="image" src="https://github.com/Neville4010/website-yipee/assets/122937544/a0e989b6-b520-46f3-99ba-036edfb52dba">
...
- For the banner, a simple, type-writing adjacent font was selected. This was to promote a 'clean' feeling to the page and not draw attention away from the information. The writing
  ...
  <img width="759" alt="image" src="https://github.com/Neville4010/website-yipee/assets/122937544/ae23bffb-3b24-4577-bdb5-abeaf52828fe">

- In both the homepage and the visit page there are maps. For the homepage (as per the requirements) there is a static map of the town. Within the visit page, there is an interactive map
  situated at the bottom of the page. This was decided as it allows the user to scope out the area and hopefully aid in planning their travels to and from without having to leave the page.
  <img width="699" alt="image" src="https://github.com/Neville4010/website-yipee/assets/122937544/f6323d23-3d1c-4728-b90a-0466bb053ed2">
